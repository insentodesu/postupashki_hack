...
> [!IMPORTANT]
> ## 📊 Аналитика проекта
> В репозитории есть отдельная папка [`analytics/`](analytics/) с полной аналитической частью решения: исследованием исходных данных, расчётами маркетинговых метрик и ROMI, а также выводами для бизнеса.
>
> - [`business_analysis.md`](analytics/business_analysis.md) — основные выводы и рекомендации;
> - [`EDA_Postupashki.ipynb`](analytics/EDA_Postupashki.ipynb) — исследовательский анализ данных;
> - [`02_marketing_romi.ipynb`](analytics/02_marketing_romi.ipynb) — расчёты маркетинговой эффективности и ROMI.
